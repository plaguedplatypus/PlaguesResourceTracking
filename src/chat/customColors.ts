...
export const trackerChatColors = [
  ...
  a1lib.mixColor(232, 47, 47), // Red invention material names.
  a1lib.mixColor(245, 135, 55), // Orange invention material names.
  a1lib.mixColor(235, 119, 2), // 10pt orange.
  a1lib.mixColor(245, 124, 1), // 12pt orange.
  a1lib.mixColor(253, 127, 0), // Orange invention component variant.
